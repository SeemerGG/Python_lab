#На вход программы подается последовательность символов заканчивающаяся нулем.Ноль в этой апоследовательность единственный среди символов оюязательно есть другие десятичные цифры.
